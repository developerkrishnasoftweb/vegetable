...
<head>
    ...
    <title> Manage Customer | <?= $app->appTitle; ?></title>
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Registered Customer</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
<!--                            <button type="button" id="addBtn" class="btn btn-info"><i class="fa fa-plus"></i> Add Admin</button><br><br>-->
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                <?php $cnt=1; foreach ($customer as $row) {?>
...
<script type="text/javascript">
    var base_path='<?php echo base_url(); ?>/customer/';
