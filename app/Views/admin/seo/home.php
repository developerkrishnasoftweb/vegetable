...
<head>
    ...
    <title> Home Page | <?= $app->appTitle; ?></title>
            ...
            <div class="row" id="form_div">
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="<?php echo base_url()."/seo/home"; ?>" role="form" method="post" enctype="multipart/form-data" id="form1">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="keywords" id="keywords"><?php echo $configuration[0]['meta_keywords']; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="description">Meta Description</label>
                                            <textarea class="form-control" name="description" id="description"><?php echo $configuration[0]['meta_description']; ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
