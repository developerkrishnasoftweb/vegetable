...
<head>
    ...
    <title> Manage Department | <?= $app->appTitle; ?></title>
                    ...
                    <div class="card card-primary">
                        ...
                        <form role="form" method="post" enctype="multipart/form-data" id="form1">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="title" id="title" placeholder="Department1,Department2,Department3,.." required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-footer">
                                <button type="submit" class="btn btn-primary right">Save Department</button>
            ...
            <div class="row" id="data_div">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <button type="button" id="addBtn" class="btn btn-info"><i class="fa fa-plus"></i> Add Department</button>
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                <?php $cnt=1; foreach ($department as $row) {?>
...
<script>
    var base_path='<?php echo base_url(); ?>/department/',deleteIds=[];
</script>
<!-- ./wrapper -->
