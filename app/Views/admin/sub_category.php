...
<head>
    ...
    <title> Manage Sub Category | <?= $app->appTitle; ?></title>
                    ...
                    <div class="card card-primary">
                        ...
                        <form role="form" method="post" enctype="multipart/form-data" id="form1">
                            ...
                            <div class="card-footer">
                                <button type="submit" class="btn btn-primary right">Save Sub Category</button>
            ...
            <div class="row" id="data_div">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <button type="button" id="addBtn" class="btn btn-info"><i class="fa fa-plus"></i> Add Sub Category</button>
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                <?php $cnt=1; foreach ($sub_category as $row) {?>
...
<script>
    var base_path='<?php echo base_url(); ?>/sub_category/',deleteIds=[];
</script>
<!-- ./wrapper -->
