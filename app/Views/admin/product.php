                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select type="text" class="form-control" name="oos" id="oos" required>
                                                <option value="n">In Stock</option>
                                                <option value="y">Out Of Stock</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <?php $cnt=1; foreach ($product as $row) {?>
                                    <tr id="row<?php echo $row['id']; ?>">
                                        ...
                                        <td><?php echo $row['unit_value'].' '.strtoupper($row['unit']); ?></td>
                                        ...
                                        <td>
                                            <a title="Add Image" href="<?= base_url().'/product/product_image/'.$row['id']; ?>"><i class="fa fa-image"></i></a>
...
<script>
    var base_path='<?php echo base_url(); ?>/product/',deleteIds=[];
</script>
<!-- ./wrapper -->
        ...
        $('#example1').on('click','.modify_data',function () {
          ...
          $.ajax({
              ...
              success : function (response) {
                  ...
                  $('#unit').val(info.unit);
                  $('#unit_value').val(info.unit_value);
