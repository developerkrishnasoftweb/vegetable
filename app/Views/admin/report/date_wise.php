...
<head>
    ...
    <title> Date wise Report | <?= $app->appTitle; ?></title>
            ...
            <div class="row" id="form_div">
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- form start -->
                        <form role="form" method="get" enctype="multipart/form-data" id="form1" action="<?= base_url(); ?>/report/get_date_wise">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
