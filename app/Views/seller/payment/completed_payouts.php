...
<head>
    ...
    <title> Completed Payouts | <?= $app->appTitle; ?></title>
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Completed Payouts</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                <?php $cnt=1; foreach ($payout as $row) {?>
                                    <tr id="row<?php echo $row['business_id']; ?>">
                                        <td><?php echo $cnt++; ?></td>
                                        <td><?php echo $row['business_id']; ?></td>
                                        <td><?php echo $row['datetime']; ?></td>
                                        <td><?php echo $row['amount']; ?></td>
                                        <td>
                                            <a href="javascript:;" class="view_details" data-id="<?php echo $row['business_id']; ?>"><i class="fa fa-eye"></i></a>
                                        </td>
                                    </tr>
                                <?php } ?>
                                </tbody>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Completed Details</h4>
...
<script>
    var base_path='<?php echo base_url(); ?>/payouts/',deleteIds=[];
</script>
<!-- ./wrapper -->
            ...
            $.ajax({
                ...
                success : function (response) {
                    ...
                    if(info.length > 0) {
                        ...
                        $('#Pending_amount').html(info[0].Pending_amount);
