...
<head>
    ...
    <title> Booking Payment History | <?= $app->appTitle; ?></title>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Booking Payment History</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item active">Payment</li>
                            <li class="breadcrumb-item active">Booking Payment History</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Booking Payment History</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
...
<script>
    var base_path='<?php echo base_url(); ?>/payouts/';
</script>
<!-- ./wrapper -->
