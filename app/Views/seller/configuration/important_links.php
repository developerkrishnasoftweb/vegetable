...
<head>
    ...
    <title> Manage Important Links | <?= $app->appTitle; ?></title>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Important Links Management</h1>
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Manage Important Links</h3>
                        </div>
                        <!-- /.card-header -->
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                <?php $cnt=1; foreach ($important as $row) {?>
...
<script type="text/javascript">
    $(document).ready(function () {
       ...
       $('#addBtn').click(function () {
            $('#form1').prop('action',base_path + 'insertImportantLinks');
            $('#data_div').hide();
            $('#form_div').fadeIn();
       });
       ...
       $('#example1').on('click','.remove_data',function () {
          ...
          if(confirm('Are you sure to remove data??')){
              $.ajax({
                  type : 'post',
                  url : base_path + 'deleteImportantLinks/' + that.data('id'),
       ...
       $('#example1').on('click','.modify_data',function () {
          ...
          $.ajax({
              type : 'post',
              url : base_path + 'modifyImportantLinks/'  + that.data('id'),
              success : function (response) {
                  ...
                  $('#text').val(info.text);
                  $('#link').val(info.link);
                  $('#form1').prop('action', base_path + 'updateImportantLinks');
                  $('#data_div').hide();
                  $('#form_div').fadeIn();
              },
              error : function (response) {
        ...
        $('#example1').on('click','.status_change',function () {
            ...
            $.ajax({
                ...
                url : base_path + 'Important_links_status_change',
                success : function (response) {
                    if(response=='yes'){
                        if(status=='y')
