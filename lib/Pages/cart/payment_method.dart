...
class PaymentMethod extends StatefulWidget {
  ...
  PaymentMethod(
      {this.dateTime, this.time, @required this.items, @required this.address});
  @override
                      ...
                      return ListTile(
                        ...
                        title: Align(
                          alignment: index == 1
                              ...
                              : Alignment(-1.2, 0.0),
                          child: Text(
                            paymentOptionItems[index].title,
                            style: Theme.of(context)
                                .textTheme
                                .bodyText1
                                .copyWith(
                                    color: paymentOptionItems[index]
                                        .color
                                        .withOpacity(0.5),
                                    fontWeight: FontWeight.bold,
                                    fontSize: 17),
                        ...
                        leading: ImageIcon(
                          AssetImage(paymentOptionItems[index].icon),
                          color: paymentOptionItems[index].color,
                        ),
                      );
                    },
                ...
                onPressed: () {
                  if (paymentMethod == null)
                    Fluttertoast.showToast(
                        msg: "Please select payment options");
                  else
                    Navigator.push(
                        context,
                        MaterialPageRoute(
